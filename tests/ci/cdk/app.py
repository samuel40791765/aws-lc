...
from cdk.aws_lc_m1_test_stack import BmFrameworkStack
...
bm_framework_build_spec_file = "cdk/codebuild/m1_test_omnibus.yaml"
BmFrameworkStack(app, "aws-lc-ci-m1-test-framework", bm_framework_build_spec_file, env=env)
