...
OPENSSL_EXPORT OCSP_RESPONSE *OCSP_RESPONSE_new(void);
OPENSSL_EXPORT void OCSP_RESPONSE_free(OCSP_RESPONSE *resp);
OPENSSL_EXPORT OCSP_RESPONSE *d2i_OCSP_RESPONSE(OCSP_RESPONSE **out,
                                        const uint8_t **inp, long len);
OPENSSL_EXPORT int i2d_OCSP_RESPONSE(const OCSP_RESPONSE *key, uint8_t **outp);

OPENSSL_EXPORT OCSP_RESPBYTES *OCSP_RESPBYTES_new(void);
OPENSSL_EXPORT void OCSP_RESPBYTES_free(OCSP_RESPBYTES *resp);
OPENSSL_EXPORT OCSP_RESPBYTES *d2i_OCSP_RESPBYTES(OCSP_RESPBYTES **out,
                                        const uint8_t **inp, long len);
OPENSSL_EXPORT int i2d_OCSP_RESPBYTES(const OCSP_RESPBYTES *resp,
                                        uint8_t **outp);
